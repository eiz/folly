...
#ifndef FOLLY_WIN32_DETAIL_THREADLOCALDETAIL_H_
#define FOLLY_WIN32_DETAIL_THREADLOCALDETAIL_H_
...
struct StaticMeta {
  ...
  static ThreadEntry* getThreadEntry() {
    ...
    ThreadEntry* threadEntry =
        static_cast<ThreadEntry*>(FlsGetValue(inst_->flsKey_));
    if (!threadEntry) {
        threadEntry = new ThreadEntry();
        FlsSetValue(inst_->flsKey_, threadEntry);
    }
    return threadEntry;
#endif
  }
  ...
  static void onThreadExit(void* ptr) {
    ...
    FlsSetValue(meta.flsKey_, nullptr);
...
#endif /* FOLLY_WIN32_DETAIL_THREADLOCALDETAIL_H_ */
